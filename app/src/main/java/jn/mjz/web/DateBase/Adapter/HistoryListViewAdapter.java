...
public class HistoryListViewAdapter extends BaseAdapter {
    ...
    public HistoryListViewAdapter(Context context, String[] stringsName, IOnItemClickListener iOnItemClickListener, IOnItemLongClickListener iOnItemLongClickListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.layout_list_view_history_item, null);
            myViewHolder.mTv = convertView.findViewById(R.id.tv_layout_list_item_history);
